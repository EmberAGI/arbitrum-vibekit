---
name: skill-creator
description: Guide for creating effective skills. Use when a user requests a new or updated skill, or when you (Agent) determine a skill should be created to extend Agent capabilities with specialized knowledge, workflows, or tool integrations.
