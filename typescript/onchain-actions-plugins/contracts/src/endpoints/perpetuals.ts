...
} from '../plugins/schemas/perpetuals.js';
...
export type PerpetualsCreatePositionRequest = z.infer<typeof PerpetualsCreatePositionRequestSchema>;
...
export const PossiblePerpetualPositionsRequestSchema = PaginatedPossibleResultsRequestSchema.merge(
  PerpetualsPositionPromptSchema,
);
...
export const PossiblePerpetualCloseRequestSchema = PaginatedPossibleResultsRequestSchema.merge(
...
export type PossiblePerpetualCloseRequest = z.infer<typeof PossiblePerpetualCloseRequestSchema>;
