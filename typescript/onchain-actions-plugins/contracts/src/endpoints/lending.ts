...
} from '../plugins/schemas/lending.js';
...
export const PossibleLendingWithdrawRequestSchema = PaginatedPossibleResultsRequestSchema.merge(
  PromptLendingWithdrawRequestSchema,
);
export type PossibleLendingWithdrawRequest = z.infer<typeof PossibleLendingWithdrawRequestSchema>;
...
export type PossibleLendingWithdrawOption = z.infer<typeof PossibleLendingWithdrawOptionSchema>;
