...
import { TokenIdentifierSchema, TokenSchema } from '../core/index.js';
import {
  BuyPtRequestSchema,
  BuyPtResponseSchema,
  BuyYtRequestSchema,
...
} from '../plugins/schemas/tokenizedYield.js';

export const CreateTokenizedYieldBuyPtEndpointRequestSchema = BuyPtRequestSchema.omit({
  inputToken: true,
  amount: true,
}).extend({
...
export const CreateTokenizedYieldBuyYtEndpointRequestSchema = BuyYtRequestSchema.omit({
  inputToken: true,
  amount: true,
}).extend({
  inputTokenUid: TokenIdentifierSchema,
...
export const CreateTokenizedYieldSellPtEndpointRequestSchema = SellPtRequestSchema.omit({
  ptToken: true,
  amount: true,
}).extend({
...
export const CreateTokenizedYieldSellYtEndpointRequestSchema = SellYtRequestSchema.omit({
  ytToken: true,
  amount: true,
}).extend({
...
export const CreateTokenizedYieldMintPtAndYtEndpointRequestSchema = MintPtAndYtRequestSchema.omit({
  inputToken: true,
  amount: true,
}).extend({
  inputTokenUid: TokenIdentifierSchema,
...
export const CreateTokenizedYieldMintPtAndYtResponseSchema = MintPtAndYtResponseSchema.omit({
  ptTokenIdentifier: true,
  ytTokenIdentifier: true,
}).extend({
  ptToken: TokenSchema,
...
export type CreateTokenizedYieldMintPTAndYt = z.infer<typeof CreateTokenizedYieldMintPtAndYtSchema>;
...
export const CreateTokenizedYieldRedeemPtEndpointRequestSchema = RedeemPtRequestSchema.omit({
  ptToken: true,
  amount: true,
}).extend({
  ptTokenUid: TokenIdentifierSchema,
...
export const CreateTokenizedYieldRedeemPtResponseSchema = RedeemPtResponseSchema.omit({
...
export const PromptTokenizedYieldRedeemPtRequestSchema = CreateTokenizedYieldRedeemPtSchema.pick({
  walletAddress: true,
  ptToken: true,
  amount: true,
  chain: true,
...
export const CreateTokenizedYieldClaimRewardsEndpointRequestSchema = ClaimRewardsRequestSchema.omit(
  { ytToken: true },
).extend({
  ytTokenUid: TokenIdentifierSchema,
});
