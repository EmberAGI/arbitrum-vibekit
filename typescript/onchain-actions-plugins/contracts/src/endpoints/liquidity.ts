...
} from '../plugins/schemas/liquidity.js';
...
export const PromptLiquidityWithdrawRequestSchema = CreateLiquidityWithdrawRequestSchema.partial();
...
export const PossibleLiquidityWithdrawResponseSchema =
  PaginatedPossibleResultsResponseSchema.extend({
    options: z
...
export type LiquidityPositionPooledToken = z.infer<typeof LiquidityPositionPooledTokenSchema>;
...
export type LiquidityPositionFeesOwedToken = z.infer<typeof LiquidityPositionFeesOwedTokenSchema>;
