...
describe('perpetual endpoint submit transaction schemas', () => {
  it('exports submit request/response schemas', () => {
    const submitRequestSchema = getSchemaExport('SubmitPerpetualsTransactionRequestSchema');
    const submitResponseSchema = getSchemaExport('SubmitPerpetualsTransactionResponseSchema');
