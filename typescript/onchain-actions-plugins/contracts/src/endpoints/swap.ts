...
export const AmountTypeSchema = z.union([
  z.literal('exactIn').describe('Specify exact input amount - you know how much you want to spend'),
  z
    .literal('exactOut')
...
export const PossibleSwapsRequestSchema =
  PaginatedPossibleResultsRequestSchema.merge(PromptSwapRequestSchema);
