...
export namespace EndpointInterfaces {
  ...
  export type PaginatedPossibleResultsRequest = pagination.PaginatedPossibleResultsRequest;
  export const PaginatedPossibleResultsResponseSchema =
    pagination.PaginatedPossibleResultsResponseSchema;
  export type PaginatedPossibleResultsResponse = pagination.PaginatedPossibleResultsResponse;
  ...
  export const CreateSwapEndpointRequestSchema = swap.CreateSwapEndpointRequestSchema;

  export const CreateLendingSupplyRequestSchema = lending.CreateLendingSupplyRequestSchema;
  export type CreateLendingSupplyRequest = lending.CreateLendingSupplyRequest;
  export const PromptLendingSupplyRequestSchema = lending.PromptLendingSupplyRequestSchema;
  export const PossibleLendingSupplyRequestSchema = lending.PossibleLendingSupplyRequestSchema;
  export type PossibleLendingSupplyRequest = lending.PossibleLendingSupplyRequest;
  export const PossibleLendingSupplyOptionSchema = lending.PossibleLendingSupplyOptionSchema;
  export type PossibleLendingSupplyOption = lending.PossibleLendingSupplyOption;
  export const PossibleLendingSupplyResponseSchema = lending.PossibleLendingSupplyResponseSchema;
  export const CreateSupplyEndpointRequestSchema = lending.CreateSupplyEndpointRequestSchema;

  export const CreateLendingBorrowRequestSchema = lending.CreateLendingBorrowRequestSchema;
  export type CreateLendingBorrowRequest = lending.CreateLendingBorrowRequest;
  export const PromptLendingBorrowRequestSchema = lending.PromptLendingBorrowRequestSchema;
  export const PossibleLendingBorrowRequestSchema = lending.PossibleLendingBorrowRequestSchema;
  export type PossibleLendingBorrowRequest = lending.PossibleLendingBorrowRequest;
  export const PossibleLendingBorrowOptionSchema = lending.PossibleLendingBorrowOptionSchema;
  export type PossibleLendingBorrowOption = lending.PossibleLendingBorrowOption;
  export const PossibleLendingBorrowResponseSchema = lending.PossibleLendingBorrowResponseSchema;
  export const CreateBorrowEndpointRequestSchema = lending.CreateBorrowEndpointRequestSchema;

  export const CreateLendingRepayRequestSchema = lending.CreateLendingRepayRequestSchema;
  export type CreateLendingRepayRequest = lending.CreateLendingRepayRequest;
  export const PromptLendingRepayRequestSchema = lending.PromptLendingRepayRequestSchema;
  export const PossibleLendingRepayRequestSchema = lending.PossibleLendingRepayRequestSchema;
  export type PossibleLendingRepayRequest = lending.PossibleLendingRepayRequest;
  export const PossibleLendingRepayOptionSchema = lending.PossibleLendingRepayOptionSchema;
  export type PossibleLendingRepayOption = lending.PossibleLendingRepayOption;
  export const PossibleLendingRepayResponseSchema = lending.PossibleLendingRepayResponseSchema;
  export const CreateRepayEndpointRequestSchema = lending.CreateRepayEndpointRequestSchema;

  export const CreateLendingWithdrawRequestSchema = lending.CreateLendingWithdrawRequestSchema;
  export type CreateLendingWithdrawRequest = lending.CreateLendingWithdrawRequest;
  export const PromptLendingWithdrawRequestSchema = lending.PromptLendingWithdrawRequestSchema;
  export const PossibleLendingWithdrawRequestSchema = lending.PossibleLendingWithdrawRequestSchema;
  export type PossibleLendingWithdrawRequest = lending.PossibleLendingWithdrawRequest;
  export const PossibleLendingWithdrawOptionSchema = lending.PossibleLendingWithdrawOptionSchema;
  export type PossibleLendingWithdrawOption = lending.PossibleLendingWithdrawOption;
  export const PossibleLendingWithdrawResponseSchema =
    lending.PossibleLendingWithdrawResponseSchema;
  export const CreateWithdrawEndpointRequestSchema = lending.CreateWithdrawEndpointRequestSchema;

  export const NonMappedPayableTokens = liquidity.NonMappedPayableTokens;
  export const CreateLiquiditySupplyRequestSchema = liquidity.CreateLiquiditySupplyRequestSchema;
  export type CreateLiquiditySupplyRequest = liquidity.CreateLiquiditySupplyRequest;
  ...
  export type CreateLiquidityWithdrawRequest = liquidity.CreateLiquidityWithdrawRequest;
  ...
  export type PossibleLiquidityWithdrawRequest = liquidity.PossibleLiquidityWithdrawRequest;
  export const LiquidityWithdrawOptionSchema = liquidity.LiquidityWithdrawOptionSchema;
  ...
  export const LiquidityPositionPooledTokenSchema = liquidity.LiquidityPositionPooledTokenSchema;
  export type LiquidityPositionPooledToken = liquidity.LiquidityPositionPooledToken;
  export const LiquidityPositionFeesOwedTokenSchema =
    liquidity.LiquidityPositionFeesOwedTokenSchema;
  export type LiquidityPositionFeesOwedToken = liquidity.LiquidityPositionFeesOwedToken;
  ...
  export type GetWalletLiquidityPositionsResponse = liquidity.GetWalletLiquidityPositionsResponse;
  export const LiquidityPoolSchema = liquidity.LiquidityPoolSchema;
  export type LiquidityPool = liquidity.LiquidityPool;
  export const GetLiquidityPoolsResponseSchema = liquidity.GetLiquidityPoolsResponseSchema;
  export type GetLiquidityPoolsResponse = liquidity.GetLiquidityPoolsResponse;
  ...
  export type CreateTokenizedYieldBuyPtResponse = tokenizedYield.CreateTokenizedYieldBuyPtResponse;
  export const CreateTokenizedYieldBuyPtSchema = tokenizedYield.CreateTokenizedYieldBuyPtSchema;
  ...
  export type CreateTokenizedYieldBuyYtResponse = tokenizedYield.CreateTokenizedYieldBuyYtResponse;
  export const CreateTokenizedYieldBuyYtSchema = tokenizedYield.CreateTokenizedYieldBuyYtSchema;
  ...
  export const CreateTokenizedYieldSellPtSchema = tokenizedYield.CreateTokenizedYieldSellPtSchema;
  ...
  export const CreateTokenizedYieldSellYtSchema = tokenizedYield.CreateTokenizedYieldSellYtSchema;
  ...
  export type CreateTokenizedYieldMintPTAndYt = tokenizedYield.CreateTokenizedYieldMintPTAndYt;
  ...
  export type CreateTokenizedYieldRedeemPt = tokenizedYield.CreateTokenizedYieldRedeemPt;
  ...
  export type CreateTokenizedYieldClaimRewards = tokenizedYield.CreateTokenizedYieldClaimRewards;
  ...
  export type PerpetualsCreatePositionRequest = perpetuals.PerpetualsCreatePositionRequest;
  ...
  export type CreatePerpetualsDecreasePlanRequest = perpetuals.CreatePerpetualsDecreasePlanRequest;
  export const SubmitPerpetualsTransactionRequestSchema =
    perpetuals.SubmitPerpetualsTransactionRequestSchema;
  export type SubmitPerpetualsTransactionRequest = perpetuals.SubmitPerpetualsTransactionRequest;
  export const SubmitPerpetualsTransactionResponseSchema =
    perpetuals.SubmitPerpetualsTransactionResponseSchema;
  export type SubmitPerpetualsTransactionResponse = perpetuals.SubmitPerpetualsTransactionResponse;
  export const PerpetualsPositionPromptSchema = perpetuals.PerpetualsPositionPromptSchema;
  export const PossiblePerpetualPositionsRequestSchema =
    perpetuals.PossiblePerpetualPositionsRequestSchema;
  export type PossiblePerpetualPositionsRequest = perpetuals.PossiblePerpetualPositionsRequest;
  export const PossiblePerpetualPositionsOptionSchema =
    perpetuals.PossiblePerpetualPositionsOptionSchema;
  export type PossiblePerpetualPositionOption = perpetuals.PossiblePerpetualPositionOption;
  export const PossiblePerpetualPositionsResponseSchema =
    perpetuals.PossiblePerpetualPositionsResponseSchema;
  export type PossiblePerpetualPositionsResponse = perpetuals.PossiblePerpetualPositionsResponse;

  export const CreatePerpetualClosePositionRequestSchema =
    perpetuals.CreatePerpetualClosePositionRequestSchema;
  export type CreatePerpetualClosePositionRequest = perpetuals.CreatePerpetualClosePositionRequest;
  export const PerpetualsCloseOrderPromptSchema = perpetuals.PerpetualsCloseOrderPromptSchema;
  export const PossiblePerpetualCloseRequestSchema = perpetuals.PossiblePerpetualCloseRequestSchema;
  export type PossiblePerpetualCloseRequest = perpetuals.PossiblePerpetualCloseRequest;
  ...
  export const GetWalletBalancesRequestSchema = queries.GetWalletBalancesRequestSchema;
  export type GetWalletBalancesRequest = queries.GetWalletBalancesRequest;
  export const GetWalletBalancesResponseSchema = queries.GetWalletBalancesResponseSchema;
