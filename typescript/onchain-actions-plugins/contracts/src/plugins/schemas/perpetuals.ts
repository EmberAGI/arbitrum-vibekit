...
import { TransactionPlanSchema, TokenIdentifierSchema } from '../../core/index.js';
...
const Base10IntegerStringSchema = z.string().regex(/^\d+$/u, 'Must be a base-10 integer string');
...
export const CreatePerpetualsIncreasePlanRequestSchema = CreatePerpetualsIncreaseQuoteRequestSchema;
...
export const CreatePerpetualsDecreasePlanRequestSchema = CreatePerpetualsDecreaseQuoteRequestSchema;
