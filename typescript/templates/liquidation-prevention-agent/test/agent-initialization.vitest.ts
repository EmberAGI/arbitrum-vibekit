...
describe('Agent Components', () => {
    beforeAll(() => {
        ...
        process.env.LIQUIDATION_PREVENTION_MCP_SERVER_URL = 'https://test-liquidation-prevention-server.com';
    });
    ...
    it('should have environment variables set for testing', () => {
        ...
        expect(process.env.LIQUIDATION_PREVENTION_MCP_SERVER_URL).toBe('https://test-liquidation-prevention-server.com');
    });
