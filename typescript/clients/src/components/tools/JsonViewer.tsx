...
function JsonNode({ data, path, depth = 0, onCopy, copiedPath, parentKey, isArrayItem, arrayIndex }: JsonNodeProps) {
    ...
    if (data === null || data === undefined || typeof data === 'boolean' || typeof data === 'number' || typeof data === 'string') {
        ...
        const colorClass = data === null || data === undefined ? 'text-gray-500' :
                ...
                return (
                    <div className="py-0.5 px-1 hover:bg-gray-600/20 rounded transition-all duration-150">
                        <div className="flex items-center gap-2 text-xs">
                            ...
                            <span className="text-gray-500 bg-gray-600/30 px-1.5 py-0.5 rounded text-[10px]">Empty Array</span>
                        </div>
                    </div>
                );
            }
            ...
            if (parentKey) {
                return (
                    <div className="py-0.5 px-1 hover:bg-gray-600/20 rounded transition-all duration-150">
                        <div className="flex items-center gap-2 text-xs">
                            <span className="text-gray-300">{parentKey}:</span>
                            <span className="text-gray-500 bg-gray-600/30 px-1.5 py-0.5 rounded text-[10px]">Empty Object</span>
                        </div>
                    </div>
                );
            }
