...
- Canceling automation must suspend future cadence and stop an active same-process scheduled invocation through the runtime stop path so later completion cannot advance cadence.
