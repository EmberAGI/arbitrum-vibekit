...
describe('collectDelegationsNode', () => {
  ...
  it('emits pending checkpoint when onboarding key advances despite identical input-required task message', async () => {
    const usdaiToken: Token = {
      tokenUid: { chainId: '42161', address: '0x0a1a1a107e45b7ced86833863f482bc5f4ed82ef' },
      name: 'USDai',
      symbol: 'USDai',
    ...
    await collectDelegationsNode(state, { configurable: { thread_id: 'thread-1' } });
