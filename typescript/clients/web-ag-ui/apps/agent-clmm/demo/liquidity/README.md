...
3. Generates **least-privilege function-call delegations** by deriving per-target 4-byte selectors from calldata, plus optional byte-level calldata pinning for safety-critical fields
