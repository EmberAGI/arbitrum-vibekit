...
describe('summarizeNode', () => {
  it('does not clear onboarding input-required state from stale completed onboardingFlow alone', async () => {
    ...
    const state = {
      thread: {
        ...
        // delegationBundle and other prerequisites are intentionally missing
