...
// dotenv not required found, skipping


const RPC_URL = process.env.POLYGON_RPC_URL || 'https://polygon-rpc.com'; // Reliable public RPC
...
async function main() {
  ...
  try {
    ...
    console.log('Failed to fetch version:', e.message);
  }
