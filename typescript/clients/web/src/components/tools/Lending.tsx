...
import { TrendingUp, CheckCircle, AlertCircle, Loader2, Wallet } from "lucide-react";
            ...
            {txPlan && txPreview && (
                <div className="rounded-lg bg-black/20 p-4 space-y-3">
                    <div className="flex items-center gap-2">
                        ...
                        <h2 className="text-sm font-semibold text-orange-400">{txPreview.action?.toUpperCase()} Preview</h2>
                    </div>
                    ...
                    <div className="bg-black/30 rounded p-3">
                        ...
                        <div className="flex items-baseline gap-2">
                            ...
                            <span className="text-sm font-semibold text-orange-400">{txPreview?.tokenName?.toUpperCase()}</span>
                        </div>
